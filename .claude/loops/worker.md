...
- **Cells team blocking issue surfaced** (anything that touches stable :7878 or risks their work) → `cells-team-coordination-needed:` + write to NEEDS_PETE via the steward path.
