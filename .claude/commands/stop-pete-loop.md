...
1. Read the current iteration count: `cat /Users/pete/Projects/wells/.claude/.pete-loop.active 2>/dev/null` (note the number — empty/missing = loop wasn't active).
2. Run: `rm -f /Users/pete/Projects/wells/.claude/.pete-loop.active`
