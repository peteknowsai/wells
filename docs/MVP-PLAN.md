...
- [ ] **Lume crashes on welld stop().** Observed: welld's stopWell call hung 35s and killed lume serve in the process. Likely a lume-side hang in the stop handler. Reproduce + patch in vendor/lume.
