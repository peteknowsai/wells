# Wells — Codex instructions

This is the wells project. See `docs/ROADMAP.md` for the broader vision and `docs/MVP-PLAN.md` for the current phased plan. The autonomous loop is documented in `.Codex/commands/mvp-wells.md`.

## Working on this repo

- Match the global AGENTS.md vibe (`~/.Codex/AGENTS.md`): opinions over hedging, brevity, no sycophancy.
